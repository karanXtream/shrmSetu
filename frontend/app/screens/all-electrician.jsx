...
export default function AllElectricianScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={{ width: 24 }} />
        <Text style={styles.headerTitle}>⚡ All Electricians</Text>
        <View style={{ width: 24 }} />
      </View>

      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 20 }}>
        <View style={styles.cardsGrid}>
          {allElectricians.map((item, index) => (
